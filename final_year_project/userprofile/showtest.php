        ...
        <div class="row">
          <div class="col-xs-12">
			...
			<p style="text-align: center; font-size:20px;"><strong>PLEASE READ ALL INSTRUCTIONS CAREFULLY!!!</strong> </p>
				...
				<li> IF YOU END THE EXAMINATION BEFORE THE TIMER COUNTS DOWN, YOU WILL BE ALLOTTED THE PRIVILEDGE TO REVIEW THE CORRECT ANSWERS BUT ONLY TO QUESTIONS ANSWERED</li>
...
{
	echo "<tr><td align=center ><a href=quiz.php?testid=$row[0]&&subid=$subid&&timer=$row[4] onClick=\" return window.confirm('Are You Sure you are ready to begin?');\"><font size=4>$row[2]</font></a></td></tr>";
}
echo "</table>";
?>
<nav>
