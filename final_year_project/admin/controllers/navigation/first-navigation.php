	      ...
	      <div class="fluid-container">
	        <div class="navbar-header">
	          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-collapse1">
                ...
                <a class="navbar-brand" href="profilehome.php"><b>The Hot Seat</b></a>	        
            </div>
	        <div class="navbar-collapse collapse" id="navbar-collapse1">
	           <ul class="nav navbar-nav">
				<li>
                       <a href="index.php"><i class="fa fa-home"></i> Main Home</a>
                   </li>
	               <li>
                       <a href="profilehome.php"><i class="fa fa-home"></i> Proflie Home</a>
                   </li>
	           </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
							...
							<li><a href="my-profile.php"><i class="fa fa-user"></i>View Profile</a></li>
                        </ul>
                    </li>	
                    <li class="dropdown">
